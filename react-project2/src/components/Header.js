...
function Header(props){
    return(
        ...
        <img width={40} height={40} src="/img/logo.png" alt="Klon"/>
        
        <div>
          <h3>React snikers</h3>
          <p className="opacity-5">magazin krosovok</p>
        </div>
        </div>
        </Link>
        <ul className="d-flex cu-p ">
          <li className="mr-30" onClick={props.onClickCart}>
          <img width={18} height={18} src="/img/cart.svg" alt="Klon1"/>
          <span>12000.:dram</span>
          </li>
        <Link to='/favorites'>
        <li  className="mr-10 cu-p">
          <img width={18} height={18} src="/img/heart.svg" alt="Klon3"/>
          </li>
        </Link>
          <li>
